 ...
 *
 */
public class LogInGuiControllerNew implements Initializable {

	private static Log log = LogFactory.getLog(LogInGuiControllerNew.class);
	...
	@FXML
    protected ComboBox comboServerType;
    @FXML
    protected ComboBox comboChooseColour;
	@FXML
	...
	public void setAppController(ClientFxGUINew appController) {
	...
	public void performLogin() {
		...
		//Farbe speichern
        colour = comboChooseColour.getValue().toString();
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		comboChooseColour.getItems().addAll(ColourTypes.DEFAULT_COLOUR, ColourTypes.WHITE_COLOUR, ColourTypes.GREY_COLOUR,
                ColourTypes.GREEN_COLOUR, ColourTypes.YELLOW_COLOUR, ColourTypes.PINK_COLOUR);
	}
}
