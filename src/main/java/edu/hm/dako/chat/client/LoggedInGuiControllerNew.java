 ...
 *
 */
public class LoggedInGuiControllerNew {

	private static Log log = LogFactory.getLog(LoggedInGuiControllerNew.class);
	...
	@FXML
	protected ListView<String> chatList;
	@FXML
	...
	public void btnLogOut_OnActionNew() {
		try {
	...
	public void btnSubmit_OnActionNew() {
		try {
